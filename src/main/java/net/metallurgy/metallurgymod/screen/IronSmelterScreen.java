...
public class IronSmelterScreen extends HandledScreen<IronSmelterScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(MetallurgyMod.MOD_ID,"textures/gui/iron_smelter_gui.png");

    public IronSmelterScreen(IronSmelterScreenHandler handler, PlayerInventory inventory, Text title) {
