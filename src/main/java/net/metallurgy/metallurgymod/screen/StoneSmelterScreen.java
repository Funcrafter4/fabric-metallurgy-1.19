...
public class StoneSmelterScreen extends HandledScreen<StoneSmelterScreenHandler> {
    private static final Identifier TEXTURE =
            new Identifier(MetallurgyMod.MOD_ID,"textures/gui/iron_smelter_gui.png");

    public StoneSmelterScreen(StoneSmelterScreenHandler handler, PlayerInventory inventory, Text title) {
