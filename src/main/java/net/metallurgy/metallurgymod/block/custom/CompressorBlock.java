...
import net.metallurgy.metallurgymod.block.entity.CompressorBlockEntity;
...
public class CompressorBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlocksEntity.COMPRESSOR_BLOCK, CompressorBlockEntity::tick);
    }
}
